...
(`elemen.sakura.ne.jp/ff14_dated_archives/`) sections this project has digested,
...
Scope is **the sections we have worked on**, not the whole site. Each file was
fetched in the course of building an `elemen-*` set (or reconning one); the
...
- **Only pages we fetched.** Index-based sections are effectively complete

...
- The additive source member sources/navmut-world-population-observations/objects/navmut-Mixedcampandsettlementobservations.zip is 20842 bytes with SHA-256 81f89bb7e0508bd2c9e3a587d3ad30dcec7a14be9bfb133df46c485d1a2ce9c7. Its embedded observations.jsonl is 34042 bytes with SHA-256 b385229a6b346f60cba88e19f1c99fbfb1dd643a3bc08c3405ebc980462cc60a.
- The two source members contain 736 unique schema-v2 observations after UUID-based additive reconciliation; the additive archive contributes 86 new UUIDs and replaces none.
- Zone counts are 128=255, 150=19, 159=168, 170=49, 190=245.
- Case-folded subject-type counts are misc=41, mmonster=1, monster=590, npc=104.
...
- Review categories are a provisional deterministic partition: ambient=396, encounter=195, misc=41, npc=104.
...
- Zones 128, 150, 170, and 190 remain numeric-only because no exact client zone binding for these ids is present in the reviewed client manifest.
...
- studies/navmut-world-population-observations/derived/review-by-zone.md carries the same 736 records grouped by zone and category.

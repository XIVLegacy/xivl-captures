# Chocobo Mount / Unmount

## What this scenario contains

Mounting and unmounting a chocobo.
...
- `sources/pcap-1.23b/objects/mount_unmount_chocobo.pcapng` (21,240 B, 13 opcodes).
...
- Service split across members: map 14.

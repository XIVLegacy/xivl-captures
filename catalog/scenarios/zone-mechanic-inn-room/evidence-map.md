# Inn Room (The Roost) - Evidence Map
...
- `move_out_of_room.pcapng` - 83,412 B, 69 distinct opcodes (map 74, world 6).
- `checkbed.pcapng` - 26,276 B, 14 distinct opcodes (map 15).
- `check_room_map.pcapng` - 28,032 B, 4 distinct opcodes (map 5).

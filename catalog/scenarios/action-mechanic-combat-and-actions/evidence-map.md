# Combat and Action Bar - Evidence Map
...
- `combat_autoattack.pcapng` - 82,908 B, 46 distinct opcodes (map 49, world 5).
- `combat_skills.pcapng` - 63,028 B, 32 distinct opcodes (map 33).
- `battle_mode_passive_mode.pcapng` - 12,776 B, 9 distinct opcodes (map 10).
- `action_and_traits.pcapng` - 37,584 B, 11 distinct opcodes (map 12).

## Observed opcodes (57 distinct)

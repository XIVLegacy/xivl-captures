...
Emote captures: dance and kneel.
...
- `sources/pcap-1.23b/objects/emote_dance.pcapng` (30,352 B, 5 opcodes).
- `sources/pcap-1.23b/objects/emote_kneel.pcapng` (23,920 B, 5 opcodes).
...
- Service split across members: map 12.

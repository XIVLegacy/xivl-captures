# Guildleve - Accept and Complete - Evidence Map
...
- `accept_leve.pcapng` - 59,576 B, 15 distinct opcodes (map 16).
- `accept_local_leve.pcapng` - 50,676 B, 15 distinct opcodes (map 16).
- `local_leve_complete.pcapng` - 358,296 B, 48 distinct opcodes (map 52, world 5).
- `party_battle_leve.pcapng` - 1,429,864 B, 66 distinct opcodes (map 70, world 8).

## Observed opcodes (81 distinct)
...
| `0x0161` | map | clientbound | _0x0161 | Application::Lua::Script::Client::Command::Network::SendLogReceiver | 48 |

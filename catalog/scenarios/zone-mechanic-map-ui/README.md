# Map UI Projection (Gridania, Coerthas)

## What this scenario contains

Map-screen UI projection captures for the Gridania and Coerthas maps.
...
- `sources/pcap-1.23b/objects/gridania_map.pcapng` (16,184 B, 4 opcodes).
- `sources/pcap-1.23b/objects/coerthas_map.pcapng` (34,364 B, 4 opcodes).
...
- Service split across members: map 10.
